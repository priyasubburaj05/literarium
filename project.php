...
$sql = "SELECT * FROM projectdetails ORDER BY ProjectName";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["ProjectName"]. "</td><td>" . $row["Description"] . "</td><td>"
.$row["Moto"]. "</td><td>"
.$row["Members"]. "</td><td>"
.$row["Leader"]. "</td><td>"
.$row["Category"]. "</td></tr>";
...
<ul>
  <li>
    <a href="Microsoft-Edge: https://localhost/Catalogue.php">
      <i class="fab fa-edge"></i>
    </a>
  </li>
  <li>
    <a href="Mozilla-Firefox: https://localhost/Catalogue.php">
      <i class="fab fa-firefox"></i>
    </a>
    </li>
  <li>
    <a href="Google-Chrome:https://localhost/Catalogue.php">
      <i class="fab fa-chrome"></i>
    </a>
    
  </li>
  <li>
    <a href="Opera: https://localhost/Catalogue.php">
